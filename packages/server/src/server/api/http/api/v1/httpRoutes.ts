        ...
        routeGroups: [
            ...
            },
            {
                ...
                routes: [
                    ...
                    {
                        method: HttpMethod.POST,
                        path: "findmy/devices/debug/data-source",
                        controller: FindMyRouter.debugDevicesDataSource
                    },
                    {
                        method: HttpMethod.POST,
                    ...
                    {
                        method: HttpMethod.POST,
                        path: "findmy/devices/debug/data-source-model",
                        controller: FindMyRouter.debugDevicesDataSourceModel
                    },
                    {
                        method: HttpMethod.POST,
                    ...
                    {
                        method: HttpMethod.POST,
                        path: "findmy/searchparty/beacons/start",
                        controller: FindMyRouter.startSearchPartyBeaconProbe
                    },
                    {
                        method: HttpMethod.POST,
                    ...
                    {
                        method: HttpMethod.POST,
                        path: "findmy/searchparty/locations/live-request",
                        controller: FindMyRouter.startSearchPartyLocationLiveRequestProbe
                    },
                    {
                        method: HttpMethod.POST,
                    ...
                    {
                        method: HttpMethod.POST,
                        path: "findmy/searchparty/locations/resolved-beacon-location",
                        controller: FindMyRouter.startSearchPartyLocationResolvedBeaconLocationProbe
                    },
                    {
                        method: HttpMethod.POST,
